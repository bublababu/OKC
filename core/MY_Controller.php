...
class MY_Controller extends MX_Controller {
	...
	private function _setup()
	{
		...
		$this->mPageTitlePostfix=empty($config['page_title_postfix']) ? '' : $config['page_title_postfix'];
		$this->mBodyClass = empty($config['body_class']) ? '' : $config['body_class'];
		if ($this->session->has_userdata('userid'))
		{
			$this->mMenu = empty($config['usermenu']) ? array() : $config['usermenu'];
		}
		else
		{
	...
	protected function render($view_file, $layout = 'default')
	{
		...
		$this->mViewData['page_title'] = $this->mPageTitlePrefix.$this->mPageTitle.$this->mPageTitlePostfix;
		$this->mViewData['page_name'] = $this->mPageTitle;
