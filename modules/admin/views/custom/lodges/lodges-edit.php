...
<?php 
$name =$lodges[0]['name'];
$active = $lodges[0]['active'];
$location_description = $lodges[0]['location_description'];
?>
<div class="row">
            ...
            <div class="custom-box">
                <div class="form-field-box">
                    ...
                    <div class="form-input-box col-md-10">
                        <input type="text" name="name" id="name" class="form-control validate[required]" value="<?php echo $name ?> ">
                    </div>
                </div>
                ...
                <div class="form-field-box">
                    ...
                    <div class="form-input-box col-xs-10">
                        <input type="radio" name="active1"  <?php echo $active=="1" ? "checked" : ""?> id="active1" class="icheck-input validate[required]" checked="" value="1">
                        <span>Yes</span>
                        &nbsp; &nbsp;
                        <input type="radio" name="active1" <?php echo $active=="0" ? "checked" : ""?>  id="active2" class="icheck-input validate[required]" value="0">
                        <span>No</span>
                    </div>
                </div>
                ...
                <div class="form-field-box">
                    ...
                    <div class="form-input-box col-md-10">
                        <textarea name="desc" id="desc" class="form-control"><?php echo $location_description ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-field-box button-container">
                    <div class="col-md-10 pull-right">
                        ...
                        <a href="lodges" class="cust-btn cancel">Cancel</a>
  ...
  $('.cancel').click(function(){
		...
		<script type="text/javascript">
			$("#lodges_edit").validationEngine({promptPosition : "bottomLeft"});
		</script>
