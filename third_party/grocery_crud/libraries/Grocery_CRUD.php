...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	{
		$customclass = $_COOKIE['customclass'];
		...
		$input = "<input id='field-{$field_info->name}' name='{$field_info->name}' type='text' value='$value' class='numeric form-control $customclass-{$field_info->name}' $extra_attributes />";
		return $input;
	}
	...
	protected function get_true_false_input($field_info,$value)
	{
		...
		$input .=
			"<div class=\"radio\"><label>
				<input id='field-{$field_info->name}-true'  class='$customclass-{$field_info->name}' type=\"radio\" name=\"{$field_info->name}\" value=\"1\" $checked />
				$true_string
			 </label> </div>";
		...
		$input .=
			"<div class=\"radio\"><label>
				<input id='field-{$field_info->name}-false' class='$customclass-{$field_info->name}' type=\"radio\" name=\"{$field_info->name}\" value=\"0\" $checked />
				$false_string
			 </label> </div>";
	...
	protected function get_string_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' class='form-control $customclass-{$field_info->name}' name='{$field_info->name}' type='text' value=\"$value\" $extra_attributes />";
		return $input;
	}
		...
		if($field_info->extras == 'text_editor')
		{
			...
			switch ($editor) {
				...
				case 'tinymce':
					...
					$this->set_js_config($this->default_javascript_path.'/jquery_plugins/config/jquery.tinymce.min.js');
			...
			$input = "<textarea id='field-{$field_info->name}' name='{$field_info->name}' class='$class_name $customclass-{$field_info->name}' >$value</textarea>";
		}
		else
		{
			$input = "<textarea id='field-{$field_info->name}' class='$customclass-{$field_info->name}' name='{$field_info->name}'>$value</textarea>";
		}
		return $input;
	}
	...
	protected function get_datetime_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' name='{$field_info->name}' type='text' value='$datetime' maxlength='19' class='datetime-input form-control $customclass-{$field_info->name}' />
	...
	protected function get_hidden_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' type='hidden' class='$customclass-{$field_info->name}' name='{$field_info->name}' value='$value' />";
		return $input;
	}
	...
	protected function get_password_input($field_info,$value)
	{
		...
		if(!empty($field_info->db_max_length))
			$extra_attributes .= "maxlength='{$field_info->db_max_length}'";
		$input = "<input id='field-{$field_info->name}' class='form-control $customclass-{$field_info->name}' name='{$field_info->name}' type='password' value='$value' $extra_attributes />";
		return $input;
	}
	...
	protected function get_date_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' name='{$field_info->name}' type='text' value='$date' maxlength='10' class='datepicker-input form-control $customclass-{$field_info->name}' />
	...
	protected function get_dropdown_input($field_info,$value)
	{
		...
		$input = "<select id='field-{$field_info->name}' name='{$field_info->name}' class='chosen-select $customclass-{$field_info->name}' data-placeholder='".$select_title."'>";
	...
	protected function get_readonly_input($field_info, $value)
	{
        ...
        return '<div id="field-'.$field_info->name.'" class="readonly_label '.$customclass.'-'.$field_info->name.'">'.$read_only_value.'</div>';
	}
	...
	protected function get_set_input($field_info,$value)
	{
		...
		$select_title = str_replace('{field_display_as}',$field_info->display_as,$this->l('set_relation_title'));
		$input = "<select id='field-{$field_info->name}' name='{$field_info->name}[]' multiple='multiple' size='8' class='chosen-multiple-select $customclass-{$field_info->name}' data-placeholder='$select_title' style='width:510px;' >";
	...
	protected function get_relation_input($field_info,$value)
	{
		...
		$select_title = str_replace('{field_display_as}',$field_info->display_as,$this->l('set_relation_title'));
		$input = "<select id='field-{$field_info->name}'  name='{$field_info->name}' class='$ajax_or_not_class $customclass-{$field_info->name}' data-placeholder='$select_title' style='width:300px'>";
	...
	protected function get_relation_n_n_input($field_info_type, $selected_values)
	{
		...
		else
		{
			...
			$input = "<select id='field-{$field_info_type->name}' name='{$field_info_type->name}[]' multiple='multiple' size='8' class='$css_class $customclass-{$field_info_type->name}' data-placeholder='$select_title' style='$width_style' >";
